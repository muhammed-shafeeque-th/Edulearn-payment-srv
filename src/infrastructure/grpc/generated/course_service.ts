...
function createBaseCreateSectionRequest(): CreateSectionRequest {
  return { courseId: "", title: "", description: undefined, order: 0, isPublished: false };
}
...
function createBaseUpdateSectionRequest(): UpdateSectionRequest {
  return { sectionId: "", title: "", description: "", isPublished: false, order: 0 };
}
...
export const CourseServiceService = {
  ...
  getAllCourse: {
    path: "/course_service.CourseService/GetAllCourse",
    requestStream: false,
    responseStream: false,
