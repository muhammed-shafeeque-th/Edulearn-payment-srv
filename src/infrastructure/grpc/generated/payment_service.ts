...
export const PaymentServiceService = {
  createPayment: {
    path: '/payment_service.PaymentService/CreatePayment' as const,
  ...
  createProviderSession: {
    path: '/payment_service.PaymentService/CreateProviderSession' as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  resolvePayment: {
    path: '/payment_service.PaymentService/ResolvePayment' as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  cancelPayment: {
    path: '/payment_service.PaymentService/CancelPayment' as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  getPayment: {
    path: '/payment_service.PaymentService/GetPayment' as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Health check endpoint */
  healthCheck: {
    path: '/payment_service.PaymentService/HealthCheck' as const,
    requestStream: false as const,
    responseStream: false as const,
